...
docker pull us.gcr.io/rookout/rookout-k8s-operator:${INNER_VERSION}
docker pull us.gcr.io/rookout/rookout-k8s-operator-ubi:${INNER_VERSION}
docker pull us.gcr.io/rookout/rookout-k8s-operator-init-container:${INNER_VERSION}
docker pull us.gcr.io/rookout/rookout-k8s-operator-init-container-ubi:${INNER_VERSION}

# Tagging image with dockerhub name and right version
docker tag us.gcr.io/rookout/rookout-k8s-operator:${INNER_VERSION} rookout/k8s-operator:${EXTERNAL_VERSION}
docker tag us.gcr.io/rookout/rookout-k8s-operator-ubi:${INNER_VERSION} rookout/k8s-operator-ubi:${EXTERNAL_VERSION}
...
docker tag us.gcr.io/rookout/rookout-k8s-operator-init-container:${INNER_VERSION} rookout/k8s-operator-init-container:${EXTERNAL_VERSION}
docker tag us.gcr.io/rookout/rookout-k8s-operator-init-container-ubi:${INNER_VERSION} rookout/k8s-operator-init-container-ubi:${EXTERNAL_VERSION}
